<div class="artikel-ribbon"></div>
<main class="artikel-main mdl-layout__content">
   <div class="artikel-container mdl-grid">
      <div class="mdl-cell mdl-cell--2-col mdl-cell--hide-tablet mdl-cell--hide-phone"></div>
      <div class="artikel-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
         <div class="artikel-crumbs mdl-color-text--grey-500">
            Google &gt; Material Design Lite &gt; How to install MDL
         </div>
         <h3>How to install MDL</h3>
         <div class="mdl-grid">
            <div class="mdl-cell mdl-cell--1-col mdl-cell--hide-tablet mdl-cell--hide-phone"></div>
            <div class="mdl-cell mdl-cell--10-col mdl-cell--12-col-phone artikel-card-image mdl-card mdl-shadow--2dp" style="background: url('<?php echo base_url() ?>assets/material-design-lite/images/slide01.jpg') center / cover;">
               <div class="mdl-card__title mdl-card--expand"></div>
               <div class="mdl-card__actions">
                  <span class="artikel-card-image__filename">How to install MDL</span>
               </div>
            </div>
         </div>
         <p>
